...
def getKeyWords(source):
    ...
    auth = str(article.authors)
    filename = "keywords/Intel/article" + company + auth + "keywords.txt"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(words))
    ...
    if auth == False:
        ...
        filename = "articleSummaryFiles/Intel/article" + company + str(counter) + "summary.csv"
        counter += 1
    else:
        filename = "articleSummaryFiles/Intel/article" + company + auth + str(counter) + "summary.csv"
        counter += 1
    #create the file
    f = open(filename,"w")
    #write the data
...
def begin(inFile):
    ...
    art_summary = getArticleSummary(source)
    auth = str(article.authors)
    filename = "articleSummaryFiles/Intel/article" + auth + "summary.csv"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(article))
...
if __name__ == '__main__':
    ...
    inFile1 = "intelDataUrls.txt" # use a parameter from the terminal?
