...
def getKeyWords(source):
    ...
    if auth == "[]":
        filename = "keywords/Microsoft/article" + company + date + "keywords.txt"
    else:
        filename = "keywords/Microsoft/article" + company + auth + "keywords.txt"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(words))
    ...
    if auth == "[]":
        ...
        filename = "articleSummaryFiles/Microsoft/article" + company + date + "summary.csv"
        counter += 1
    else:
        filename = "articleSummaryFiles/Microsoft/article" + company + auth + str(counter) + "summary.csv"
        counter += 1
    #create the file
    f = open(filename,"w")
    #write the data
...
def begin(inFile):
    ...
    auth = str(article.authors)
    date = str(getArticleDate(source))
    filename = "articleSummaryFiles/Microsoft/article" + auth + "summary.csv"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(article))
...
if __name__ == '__main__':
    ...
    inFile1 = "microsoftDataUrls.txt" # use a parameter from the terminal?
