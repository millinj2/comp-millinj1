...
def getKeyWords(source):
    ...
    auth = str(article.authors)
    filename = "keywords/Google/article" + company + auth + "keywords.txt"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(words))
    ...
    if auth == False:
        ...
        filename = "articleSummaryFiles/Google/article" + company + str(counter) + "summary.csv"
        counter += 1
    else:
        filename = "articleSummaryFiles/Google/article" + company + auth + str(counter) + "summary.csv"
        counter += 1
    #create the file
    f = open(filename,"w")
    #write the data
...
def begin(inFile):
    ...
    art_summary = getArticleSummary(source)
    auth = str(article.authors)
    filename = "articleSummaryFiles/Google/article" + auth + "summary.csv"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(article))
