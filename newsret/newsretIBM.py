...
def getKeyWords(source):
    ...
    auth = str(article.authors)
    sum_line = str(getArticleSummary(source))[:5]

    if auth == "[]":
        filename = "keywords/IBM/article" + sum_line + "keywords.txt"
    else:
        filename = "keywords/IBM/article" + auth + "keywords.txt"
    #create the file
    f = open(filename,"w")
    #write the data
    f.write(str(words))
    ...
    print(ref)
    counter = 0
    date = str(getArticleDate(source))
    sum_line = str(getArticleSummary(source))[:5]

    if auth == "[]":
        # for filename in filname:
        filename = "articleSummaryFiles/IBM/article" + company + sum_line + str(counter) + "summary.csv"
        counter += 1
    else:
        filename = "articleSummaryFiles/IBM/article" + company + auth + str(counter) + "summary.csv"
        counter += 1
    #create the file
    f = open(filename,"w")
    #write the data
...
def begin(inFile):
    ...
    if auth == False:
        # for filename in filname:
        filename = "articleSummaryFiles/IBM/article" + company + date + str(counter) + "summary.csv"
        counter += 1
    else:
        filename = "articleSummaryFiles/IBM/article" + company + auth + date + str(counter) + "summary.csv"
        counter += 1
    #create the file
    f = open(filename,"w")
    #write the data
...
if __name__ == '__main__':
    ...
    inFile1 = "ibmDataUrls.txt" # use a parameter from the terminal?
